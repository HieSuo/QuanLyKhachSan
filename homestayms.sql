...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th1 05, 2024 lúc 04:12 PM
...
(2, 'Phòng Đơn', 13000, 11, 'Số giường 1 <br>\nLoại giường: đơn <br>\nTiện nghi: wifi, nóng lạnh, điều hòa '),
...
(17, 'Phòng 3', 1, 3, 'Phòng 3<br>\nhehe<br>\ntest<br>'),
(19, 'Phòng 5', 500000, 5, '5 người'),
(20, 'Phòng 6 người', 30000, 6, 'Phòng 6 <br>\ntest<br>');
...
(10, '123456789', 'thuyhoangyb2003@gmail.com', 'Thạch Thất Hà Nội', '083800211111', '001203045314', 'ABC');
...
--
ALTER TABLE `khachhang`
  MODIFY `id_khachhang` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT cho bảng `loaiphong`
--
ALTER TABLE `loaiphong`
  MODIFY `id_loaiphong` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;

--
-- AUTO_INCREMENT cho bảng `nguoidung`
--
ALTER TABLE `nguoidung`
  MODIFY `id_nguoidung` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
...
--
ALTER TABLE `phieukhachhang`
  MODIFY `id_pkh` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=36;
...
--
ALTER TABLE `tk_kh_online`
  MODIFY `id_tk_online` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
